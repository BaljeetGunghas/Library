...
const MobileNaveBar = ({ showNav, closeNav }: Props) => {
    ...
    return (
        <>
            ...
            <div className={`${navOpen} text-white transform transition-all duration-500 delay-300  fixed justify-center flex   flex-col h-full w-[80%] sm:w-[60%] bg-[#0f0715] space-y-6 z-100  `}>
                ...
                {/* {close button} */}
                <div className='flex justify-center items-center space-x-0 absolute -top-[1.1rem] '>
