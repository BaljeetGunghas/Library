        ...
        <>
            ...
            <main className="min-h-screen main_bg text-white px-6 py-[8rem]">
                <div className="max-w-6xl mx-auto">
                    ...
                    <p
                        className="text-lg md:text-xl text-center max-w-3xl mx-auto mb-12 text-gray-300"
                        data-aos="fade-up"
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        {/* Section 1 */}
                        <div
                            className="bg-white/5 backdrop-blur-lg p-6 rounded-xl border border-white/10 hover:shadow-lg transition"
                            data-aos="fade-up"
                            data-aos-delay="100"
                        >
